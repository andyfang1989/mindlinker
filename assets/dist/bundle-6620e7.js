...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
    ...
    drawForeGround() {
        let foreground = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY, 'foreground');
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__UIUtil__["a" /* rescaleObject */])(foreground, this.game, 1, 1.2);
        foreground.anchor.setTo(0.5, 0.5);
    }
    ...
    drawMainCharacterAtStartingPosition() {
        let mainCharacter = this.game.add.button(this.resourceStartX, this.resourceStartY, this.gameContext.spritesheets[0].key, this.addResource, { key: 'MAIN_CHARACTER' });
    ...
    drawInteractionItems() {
        for (let i = 0; i < this.taskContext.interactionItems.length; i++) {
            ...
            let interactionItem = this.game.add.button(this.resourceStartX, this.resourceStartY, conf.spriteSheetKey, this.addResource, { key: conf.spriteKey, xoffset: conf.xoffset, yoffset: conf.yoffset });
    ...
    drawItems() {
        for (let i = 0; i < this.taskContext.items.length; i++) {
            ...
            let item = this.game.add.button(this.resourceStartX, this.resourceStartY, conf.key, this.addResource, { key: conf.key, xoffset: conf.xoffset, yoffset: conf.yoffset });
    ...
    drawGridBoard() {
        ...
        for (let r = 0; r < gridYSize; r++) {
            for (let c = r % 2; c < gridXSize; c += 2) {
                ...
                let gridImage = this.game.add.sprite(ix, iy, 'grid');
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__UIUtil__["a" /* rescaleObject */])(gridImage, this.game, 1, 1);
                gridImage.anchor.setTo(0.5, 0.5);
            }
        }
    }
...
//# sourceMappingURL=bundle-6620e7.js.map