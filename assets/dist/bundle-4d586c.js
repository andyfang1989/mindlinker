...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
    ...
    drawMainCharacterAtStartingPosition() {
        this.mainCharacter = this.game.add.button(this.resourceStartX, this.resourceStartY, this.gameContext.spritesheets[0].key, this.addResource, { key: this.mainSpriteKey, state: this });
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__UIUtil__["a" /* rescaleObject */])(this.mainCharacter, this.game, 1, 1);
        this.mainCharacter.anchor.setTo(0.5, 0.5);
        this.resourceStartX += __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__UIUtil__["b" /* rescaleXOffset */])(this.mainCharacter.width, this.game);
    ...
    drawItems() {
        for (let i = 0; i < this.taskContext.items.length; i++) {
            ...
            let item = this.game.add.button(this.resourceStartX, this.resourceStartY, conf.key, this.addResource, { key: conf.key, xoffset: conf.xoffset, yoffset: conf.yoffset, interactive: false, tate: this });
    ...
    addResource() {
        if (this.key === this.state.mainSpriteKey) {
            ...
            this.state.drawMainCharacter(this.state.selectedX, this.state.selectedY, this.key);
            ...
            for (let i = 0; i < this.state.taskContext.interactionItems.length; i++) {
                ...
                if (interactiveItem.spriteKey === this.key) {
                    ...
                    this.state.drawItem(this.state.selectedX, this.state.selectedY, this.xoffset, this.yoffset);
                    return;
                }
            }
        } else {
        ...
        console.log(JSON.stringify(this.state.taskContext));
    }
...
//# sourceMappingURL=bundle-4d586c.js.map