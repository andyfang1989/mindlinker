...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
    ...
    drawItem(x, y, xoffset, yoffset, key, width, height) {
        ...
        const targetGridYMid = this.gridStartY + Math.round(y * this.step_height_in_pixel) + __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__UIUtil__["b" /* rescaleXOffset */])(Math.round(yoffset * height), this.game);
        this.drawSprite(targetGridXMid, targetGridYMid, key);
    }
...
//# sourceMappingURL=bundle-8192f5.js.map